...
and install both MySQL and Cron (for running scheduled tasks). 
    ...
    rhc app create drupal8 php-5.4 mysql cron https://cartreflect-claytondev.rhcloud.com/reflect?github=phase2/openshift-community-drush-master
...
Create a PHP 5.4 application with MySQL and Cron support and the latest Drush.
    ...
    rhc app create drupal8 php-5.4 mysql cron https://cartreflect-claytondev.rhcloud.com/reflect?github=phase2/openshift-community-drush-master --from-code=git://github.com/phase2/drupal-quickstart.git
